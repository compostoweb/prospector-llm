...
export const MESSAGE_TYPES = {
  ...
  REMOVE_CAPTURED_POST: "REMOVE_CAPTURED_POST",
  CLEAR_CAPTURED_POSTS: "CLEAR_CAPTURED_POSTS",
...
export type ExtensionMessage =
  ...
  | {
      type: typeof MESSAGE_TYPES.REMOVE_CAPTURED_POST;
      payload: { candidateKey: string };
    }
  | { type: typeof MESSAGE_TYPES.CLEAR_CAPTURED_POSTS }
  | {
