...
PLAYBOOK: dict[str, dict[str, PlaybookEntry]] = {
    ...
    "financeiro": {
        ...
        "controller": PlaybookEntry(
            sector="financeiro", role="controller",
        ...
        "analista": PlaybookEntry(
            sector="financeiro", role="analista",
    ...
    "juridico": {
        ...
        "gestor_juridico": PlaybookEntry(
            sector="juridico", role="gestor_juridico",
    ...
    "saude": {
        ...
        "medico_socio": PlaybookEntry(
            sector="saude", role="medico_socio",
    ...
    "industria": {
        ...
        "gerente_logistica": PlaybookEntry(
            sector="industria", role="gerente_logistica",
        ...
        "ti_industria": PlaybookEntry(
            sector="industria", role="ti_industria",
    ...
    "varejo": {
        "ceo_ecommerce": PlaybookEntry(
            sector="varejo", role="ceo_ecommerce",
        ...
        "gerente_operacoes": PlaybookEntry(
            sector="varejo", role="gerente_operacoes",
        ...
        "gerente_crm": PlaybookEntry(
            sector="varejo", role="gerente_crm",
    ...
    "educacao": {
        "diretor_academico": PlaybookEntry(
            sector="educacao", role="diretor_academico",
        ...
        "financeiro_educacao": PlaybookEntry(
            sector="educacao", role="financeiro_educacao",
        ...
        "coordenador_pedagogico": PlaybookEntry(
            sector="educacao", role="coordenador_pedagogico",
    ...
    "imobiliario": {
        "diretor_comercial": PlaybookEntry(
            sector="imobiliario", role="diretor_comercial",
        ...
        "gerente_obras": PlaybookEntry(
            sector="imobiliario", role="gerente_obras",
        ...
        "pos_venda": PlaybookEntry(
            sector="imobiliario", role="pos_venda",
    ...
    "seguros": {
        "ceo_fintech": PlaybookEntry(
            sector="seguros", role="ceo_fintech",
        ...
        "analise_credito": PlaybookEntry(
            sector="seguros", role="analise_credito",
        ...
        "compliance": PlaybookEntry(
            sector="seguros", role="compliance",
    ...
    "agro": {
        ...
        "financeiro_agro": PlaybookEntry(
            sector="agro", role="financeiro_agro",
        ...
        "rastreabilidade": PlaybookEntry(
            sector="agro", role="rastreabilidade",
    ...
    "agencia": {
        ...
        "conteudo_agencia": PlaybookEntry(
            sector="agencia", role="conteudo_agencia",
...
_SECTOR_KEYWORDS: dict[str, list[str]] = {
    "financeiro": [
        "financeiro", "contabil", "contabilidade", "contábil", "accounting",
        "finance", "bpo", "auditoria", "fiscal", "tributário", "tributario",
        "escritório contábil", "escritorio contabil", "ctrl",
    ],
    "juridico": [
        "jurídico", "juridico", "advocacia", "law", "legal", "litigi",
        "escritório de advoc", "escritorio de advoc", "tribunal",
    ],
    "saude": [
        "saúde", "saude", "clínica", "clinica", "hospital", "médico", "medico",
        "odont", "farmác", "farmac", "laborat", "health", "plano de saúde",
        "plano de saude",
    ],
    "industria": [
        "indústria", "industria", "industrial", "manufacturing", "fábrica",
        "fabrica", "logíst", "logist", "supply chain", "transport", "distribuidor",
    ],
    "varejo": [
        "varejo", "retail", "e-commerce", "ecommerce", "loja", "marketplace",
        "fulfillment", "atacado",
    ],
    "educacao": [
        "educação", "educacao", "edtech", "escola", "faculdade", "universidade",
        "ensino", "curso", "treinamento corporativo",
    ],
    "imobiliario": [
        "imobiliária", "imobiliaria", "construtora", "incorporadora", "corretor",
        "real estate",
    ],
    "seguros": [
        "seguro", "seguradora", "fintech", "crédito", "credito", "financiamento",
        "banco", "pagamento", "investimento",
    ],
    "agro": [
        "agro", "agrícola", "agricola", "cooperativa", "fazenda", "rural",
        "agroindustrial",
    ],
    "rh": [
        "recursos humanos", "rh", "human resources", "hr", "talentos", "gente",
        "people", "departamento pessoal",
    ],
    "ti": [
        "tecnologia", "software", "saas", "tech", "startup", "desenvolvimento",
        "ti ", " ti", "it ", " it",
    ],
    "agencia": [
        "agência", "agencia", "marketing digital", "publicidade", "comunicação",
        "comunicacao", "mídia", "midia",
    ],
    "marketing": [
        "marketing", "crm", "e-mail marketing", "growth",
    ],
}
...
_ROLE_KEYWORDS: dict[str, list[str]] = {
    ...
    "gestor_juridico": [
        "gerente jurídico", "gerente juridico", "coordenador jurídico",
        "coordenador juridico", "legal ops", "legalops",
    ],
    "diretor_juridico": [
        "diretor jurídico", "diretor juridico", "general counsel", "gc ",
        "chief legal",
    ],
    ...
    "gerente_administrativo": [
        "gerente administrativo", "gerente operacional", "coord. admin",
    ...
    # Genérico CEO/Operações (fallback catch-all)
    "ceo_ecommerce": ["ceo", "fundador", "founder", "dono", "proprietario", "proprietário"],
}
...
def detect_role(job_title: str | None) -> str | None:
...
def get_lead_playbook(lead: object) -> PlaybookEntry | None:
    ...
    Retorna None se não houver correspondência suficiente para ser útil.
    """
    ...
    if sector and role:
        ...
        if fallback_sector:
            return PLAYBOOK.get(fallback_sector, {}).get(role)

    if sector and not role:
        # Retorna o primeiro cargo do setor como proxy genérico
        sector_data = PLAYBOOK.get(sector, {})
        if sector_data:
            return next(iter(sector_data.values()))
...
def score_lead_icp(lead: object) -> str:
    ...
    decision_roles = {
        "cfo", "coo", "ceo_cto_ti", "ceo_ecommerce", "ceo_agencia", "ceo_fintech",
        "diretor_industrial", "diretor_juridico", "diretor_clinica",
        "diretor_comercial", "diretor_agro", "chro", "cmo",
        "socio_advocacia",
    }
